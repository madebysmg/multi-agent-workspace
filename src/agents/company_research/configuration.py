...
class Configuration(BaseModel):
    ...
    llm_model: Annotated[
        ...
        Field(
            ...
            Note: src/common/llm.py always builds ChatAnthropic, so only Claude
            model names work without code changes.
    ...
    search_provider: Annotated[
        ...
        Field(
            ...
            - google_adk: Google Programmable Search (Custom Search JSON API) via
              langchain-google-community; needs GOOGLE_API_KEY and GOOGLE_CSE_ID.
              Despite the name it does not use Google ADK or Gemini. Falls back to Tavily.
            - hybrid: first half of the queries with tavily, the rest with google_adk
    ...
    use_gemini_for_google_search: Annotated[
        bool,
        Field(
            description="Currently unused: the search and LLM code do not read this flag"
        ),
    ] = True
