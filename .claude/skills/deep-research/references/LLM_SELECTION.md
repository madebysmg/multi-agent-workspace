...
- Gemini has a native google_search tool, but this agent does not use it (`google_adk` here means Google Programmable Search)
...
- Use: **DeepSeek** (after adapting `get_llm()`) + **DuckDuckGo** (no search API key)
- Cost: ~$5-10/month
