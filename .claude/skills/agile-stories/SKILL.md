...
This skill is self-contained: the story format and AC guidance above are the full reference. No separate reference files (story guide, AC examples, blank template) ship with it.
