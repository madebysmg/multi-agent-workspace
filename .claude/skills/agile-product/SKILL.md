...
No separate example file ships with this skill; follow the section structure above.
...
This skill is self-contained: the PRD structure and guidance above are the full reference. No separate reference files (PRD guide, example PRD, checklist) ship with it.
