...
> **All performance and cost figures in this document are design-stage estimates (설계 추정), not measurements.** The repository contains no benchmark or production data behind them, and the v3.0 infrastructure exists only as design documents.
...
## Estimated Numbers (설계 추정, not measured)
...
**Estimated savings (설계 추정)**: 12.5 hours → 90 sec, $15 → $1.50 (with caching)
