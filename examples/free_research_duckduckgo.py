"""
Research example using DuckDuckGo (no search API key needed).

This example demonstrates how to run deep research without a paid
search API, using DuckDuckGo as the search provider.

No search API key required - just ANTHROPIC_API_KEY for the LLM.

Requirements:
- pip install -U ddgs   (the package langchain-community's DuckDuckGo wrapper imports)
